...
if __name__ == '__main__':
    ...
    lmdb_engine = LMDBEngine('/home/starc/CV/MetaAvatar/core/libs/GAGAvatar_track/datasets/data', write=True)
    #lmdb_engine = LMDBEngine('/home/starc/CV/GAGAvatar/data/FEED_front', write=True)
    VIDEO_DIRS=[os.path.join('/home/starc/CV/MetaAvatar/core/libs/GAGAvatar_track/datasets/IDDatasets', folder) for folder in os.listdir('/home/starc/CV/MetaAvatar/core/libs/GAGAvatar_track/datasets/IDDatasets')]
    #VIDEO_DIRS=[os.path.join('/home/starc/CV/GAGAvatar/FEED_front', folder) for folder in os.listdir('/home/starc/CV/GAGAvatar/FEED_front')]
    print(VIDEO_DIRS)
    for vidx, video_dir_path in enumerate(VIDEO_DIRS):
        frames = glob.glob(f'{video_dir_path}/*.png') # image name shuold be [frameid.jpg]
    ...
    lmdb_engine.random_visualize(os.path.join('/home/starc/CV/MetaAvatar/core/libs/GAGAvatar_track/datasets/data', 'visualize.jpg'))
    lmdb_engine.close()
